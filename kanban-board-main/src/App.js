...
function App() {
  ...
  const priorityLabels = {
    0: (
      <div className="user-label">
        <img
          src="https://cdn-icons-png.flaticon.com/128/9974/9974563.png"
          className="user-pic"
          alt="No Priority"
        />{" "}
        No Priority
    ...
    2: (
      <div className="user-label">
        <img
          src={process.env.PUBLIC_URL + "/h.jpg"}
          className="user-pic"
          alt="High"
        />{" "}
        High
    ...
    1: (
      <div className="user-label">
        <img
          src="https://th.bing.com/th/id/OIP.t_am8cWG4D5b6mSxAAY48wHaHa?rs=1&pid=ImgDetMain"
          className="user-pic"
          alt="Urgent"
        />{" "}
        Urgent
  ...
  const userLabels = users.reduce((labels, user) => {
    ...
    const last = nameParts.length > 1 ? nameParts[1] : "";
    const firstLetterFirstName = first.charAt(0).toUpperCase();
    const firstLetterLastName = last.charAt(0).toUpperCase();
